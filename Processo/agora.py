...
def ler():
    global planilha
    try:
        with open("/Users/brunoribeiro/Documents/CESAR School/Fundamentos de Programação/Projeto/transactions.csv", "r") as file:
...
def armazena():
    global planilha
    with open("/Users/brunoribeiro/Documents/CESAR School/Fundamentos de Programação/Projeto/transactions.csv", "w+", encoding='utf-8') as file:
...
def adicao():
    ...
    with open("/Users/brunoribeiro/Documents/CESAR School/Fundamentos de Programação/Projeto/transactions.csv", "w") as file:
...
def delete():
    print("Apagando transação existente:")
    with open("/Users/brunoribeiro/Documents/CESAR School/Fundamentos de Programação/Projeto/transactions.csv", "r") as file:
        nome=str(input("Nome: ")).title() #Acho mais bonito quando inicia com maiúsculo kkk
        categoria=str(input("Categoria: ")).title()
